            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="contact_form" class="m-t-40" action="{{ route('contracts.update', $contract->id) }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            {{ method_field('PUT') }}
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="cargo_type" id="cargo_type" required class="form-control">
                                    ...
                                    <div class="form-group">
                                        <label for="value">Transport Charges</label>
                                        <input type="number" required id="value" name="value" class="form-control" placeholder="Value">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="file">Contract Document </label>
                                        <input type="file" required id="file" name="file" class="form-control" placeholder="Contract Document">
                                    </div>
                                    <div class="form-group">
