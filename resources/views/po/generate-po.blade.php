                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 table-responsive m-t-40">
                        <form id="cargo_details" action="" onsubmit="event.preventDefault(); addPOdata(this)">
                            ...
                            <div class="row">
                                ...
                                <input type="hidden" value="{{ $quotation->project_id }}" name="project_id">
                    ...
                    <div class="col-md-12">
                        <div class="pull-right m-t-30 text-right">
                            ...
                            <div class="col-sm-12">
                                <button onclick="storeServiceData()" class="btn btn-block btn-primary po-gen">Save</button>
                            </div>
                        </div>
...
@section('scripts')
    <script>
        ...
        function storeServiceData() {
            $('.po-gen').attr('disabled',true).text('Please wait');
