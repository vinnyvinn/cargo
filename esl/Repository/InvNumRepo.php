...
//            'ExtOrderNum',
            ...
            'ForeignCurrencyID' => $invoiceData->inputCur == 'KES' ? 0 : 1,
//            'GrvSplitFixedAmnt',
//            'GrvSplitFixedCost',
                'InvDate' => Carbon::now(),
//            'InvDisc',
...
//            'InvNum_iModifiedBranchID',
                'InvNumber' => 'INV00'.(count(InvNum::all())+1),
                //total invoice line
                'InvTotExcl' => $invoiceData->services->sum('total'),
...
//            'bLinkedTemplate',
                'bTaxPerLine' => 1,
//            'bUseFixedPrices',
                'cAccountName' => $invoiceData->customer->Name,
//            'cAuthorisedBy',
//            'cCellular',
//            'cClaimNumber',
//            'cContact',
